...
if (isset($_POST['id_account'],$_POST['id_profession'],$_POST['type'], $_POST['description'], $_POST['duration'], $_POST['duration_unit'], $_POST['experience'], $_POST['min_salary'], $_POST['location'],$_POST['key'])) {
